    ...
    <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-8">
      ...
      >
        ...
        <p className="text-muted-foreground text-sm">
          Capturing the best moments of GCPL Season 4
        </p>
      </motion.div>
        ...
        {filteredImages.map((image, index) => (
          ...
          >
            <div className="glass rounded-2xl overflow-hidden hover:scale-[1.02] transition-all duration-300">
              ...
              <div className="relative aspect-video bg-gradient-to-br from-green-500/10 via-card to-lime-500/10 flex items-center justify-center overflow-hidden">
