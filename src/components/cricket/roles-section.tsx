    ...
    <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-8">
      ...
      >
        ...
        <p className="text-muted-foreground text-sm">
          Everyone plays a part in making gully cricket special
        </p>
      </motion.div>
      ...
      <motion.div
        ...
        className="mt-8 glass rounded-2xl p-6 sm:p-8 text-center border border-green-500/10"
      >
        <h3 className="text-xl font-bold mb-2 text-cricket-gradient">
          Ready to Join the Action?
        </h3>
        <p className="text-sm text-muted-foreground mb-4 max-w-md mx-auto">
          Whether you want to play, umpire, or just cheer from the sidelines — 
          there&apos;s a place for everyone in GCPL!
        </p>
        <div className="flex flex-wrap items-center justify-center gap-3">
          <Badge className="bg-green-500/10 text-green-400 border-green-500/20 text-xs px-3 py-1.5">
